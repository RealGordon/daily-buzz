...
touch candidates.txt && touch issues.txt
...
touch  startups/disruptors/tech.txt && touch  startups/disruptors/design.txt && touch  startups/disruptors/education.txt
